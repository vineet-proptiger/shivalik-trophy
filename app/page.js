    ...
    <main className="relative min-h-screen bg-white">
      ...
      <div className="sticky-bottom-bar">
        <a
          ...
          className="flex-1 flex items-center justify-center btn-primary !py-3 !px-0 !rounded-none"
        >
        ...
        <button
          onClick={() => setIsOpen(true)}
          className="flex-1 flex items-center justify-center btn-gold !py-3 !px-0 !rounded-none"
        >
        ...
        <a
          ...
          className="flex-1 flex items-center justify-center py-3 !px-0 text-white transition-all hover:bg-white hover:text-[#25D366] hover:border hover:border-[#25D366]"
