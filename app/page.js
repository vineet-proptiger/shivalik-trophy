    ...
    <main className="relative min-h-screen bg-white">
      ...
      <div className="sticky-bottom-bar">
        <a
          ...
          className="flex-1 flex items-center justify-center gap-1.5 btn-primary !py-3.5 !rounded-none"
        >
        ...
        <button
          onClick={() => setIsOpen(true)}
          className="flex-1 flex items-center justify-center gap-1.5 btn-gold !py-3.5 !rounded-none"
        >
        ...
        <a
          ...
          className="flex-1 flex items-center justify-center gap-1.5 py-3.5 text-white font-semibold text-sm transition-all hover:bg-white hover:text-[#25D366] hover:border hover:border-[#25D366]"
